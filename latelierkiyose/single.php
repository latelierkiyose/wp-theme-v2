					...
					<ul class="blog-single__share-links">
						<li>
							<a
								...
								aria-label="<?php echo esc_attr( sprintf( /* translators: %s: title of the blog post */ __( 'Partager %s sur Facebook', 'kiyose' ), get_the_title() ) ); ?>"
						...
						<li>
							<a
								href="https://www.linkedin.com/sharing/share-offsite/?url=<?php echo esc_url( get_permalink() ); ?>"
								target="_blank"
								rel="noopener noreferrer"
								aria-label="<?php echo esc_attr( sprintf( /* translators: %s: title of the blog post */ __( 'Partager %s sur LinkedIn', 'kiyose' ), get_the_title() ) ); ?>"
						...
						<li>
							<button
								...
								aria-label="<?php echo esc_attr( sprintf( /* translators: %s: title of the blog post */ __( 'Copier le lien de %s pour Instagram', 'kiyose' ), get_the_title() ) ); ?>"
							>
								<svg width="24" height="24" viewBox="0 0 24 24" fill="currentColor" aria-hidden="true">
