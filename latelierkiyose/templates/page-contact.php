					...
					<div class="contact-info">
						...
						<div class="contact-info__social">
							...
							<ul class="social-links">
								<li>
									<a href="https://www.facebook.com/latelierkiyose" target="_blank" rel="noopener noreferrer" aria-label="Facebook (ouverture dans un nouvel onglet)">
								...
								<li>
									<a href="https://www.instagram.com/latelierkiyose" target="_blank" rel="noopener noreferrer" aria-label="Instagram (ouverture dans un nouvel onglet)">
										<svg aria-hidden="true" focusable="false" width="24" height="24" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
								...
								<li>
									<a href="https://www.linkedin.com/company/latelierkiyose" target="_blank" rel="noopener noreferrer" aria-label="LinkedIn (ouverture dans un nouvel onglet)">
										<svg aria-hidden="true" focusable="false" width="24" height="24" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
